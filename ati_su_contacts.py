...
exist_df = pd.read_excel("xlsx_files/ati_multicountry_contacts_04.12.2023.xlsx").to_dict("index")

exist_ati_ids = list(map(lambda x: x['atiId'],exist_df.values()))
...
#     if "error" in res and "reason" in res:
#         print()
#         pprint(res)
#         break
