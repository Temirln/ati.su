...
if __name__ == "__main__":
    ...
    base_url = "https://reg.iteca.kz/list/s/auth_s.aspx?ExhCode=TransKazakhstan%202023&_ga=2.26898489.523181830.1698904204-335766182.1698904204"
    ...
    links = [
        (
            index,
            f'https://reg.iteca.kz/list/detailsfull.aspx?link={a.find("a").get("href").split("?link=")[1]}',
        )
        for index, a in enumerate(soup.find_all("div", {"class": "exhib-name"}))
    ]
    output_file = "./ati.su/translogistica"
